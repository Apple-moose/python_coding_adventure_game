...
exposed on many pages but, somehow, it's all gibberish, nothing is usable...At this point, be honest: you start building internal FRUSTRATION or \
you calmly turn to other ressources and STUDY some more? Maybe you ask a coder FRIEND (#COLLEAGUE) or turn to some CHATGPT consulting? (you could always SLEEP on it...)",
...
would carry around a rubber duck and debug their code by forcing themselves to explain it, line by line, to the duck (press B+A+C+K, in that order with a fingers \
...
to the kitchen slowly, thinking about what you will find there...You take the opportunity to drink a bit of water and \
as your eyes fixes a box on the counter with a big 'Merci' written on it... Steal/get some CHOCOLATE or \
BACK to work?",
    "tea": "You wipe away the brown from the corners of your smile and notice the water boiler. Now, how about preparing \
yourself a nice cup of TEA? Maybe eat another piece of CHOCOLATE? ..or BACK to work for some reason...???",
    "sandwich": "Waiting for the water to boil, you prepare your cup and check in the fridge for some cream while you \
...
one of your favorite SANDWICH. Again: 'What's the rush, right? Very tempting. It would sure take your belly out of the equation in your next coding session...",
    "break": "There it is: true pleasure. A Happy brain in an Happy body. What more? Well, how about a little BREAK for \
...
another TEA, grab some CHOCOLATE...",
...
You do your best to explain the matter at hand...and your friend gets half of it. During the exchange, he points you out to an obscure webChat \
where some likewise issues are being discussed. You thank your friend for nothing and start pasting every lines of code \
...
devoid of any console logging and predictable variable names. The code is unreadable but, once pasted, runs smooth like butter. \
...
made to work in a mental institution...but you might become a patient if you let all this anger control yourself! \
...
Time to lick you wounds, admit defeat and gather your strengh for the next fight. Another day, another code to write....what will you do? \
START AGAIN, meditate on your coder's PROFILE or just QUIT?",
    "sleep": "Time to get your 'Mojo' back, meditate, and experience the cycle of life again. Breathing in and out. This is no lazyness (or is it?). \
...
formulating solutions within a smile. Your refreshed self is winning, the rest bears its fruit. You feel wiser and a little more proficient at coding. How about that?\
...
What does this experience teaches you? That you need to 'CALM DOWN', or go the toolbox, get the HAMMER and bring that \
stupid wall down?",
...
and verbal and nonverbal communication. (type 'BACK' exactly, without any mistake or I will not understand!)",
    "success": "OH! You did it! WOW! Impressive. You do a little dance...and just between us: you know it's 3 a.m. right? \
Did you missed that call from your mother? You will probably be coding in bed also, good luck sleeping! \
...
solutions = {
    ...
    "stack overflow": {"frustration": "frustration"},
    "study": {"duck": "duck", "kitchen": "kitchen", "frustration": "frustration"},
    "friend": {"start": "start"},
    "chatgpt": {"code": "start"},
    ...
    "obsess": {"abandon": "abandon", "profile": "profile", "start": "start"},
    "abandon": {"start again": "start", "profile": "profile"},
    "sleep": {"write code": "first options", "next time": "start", "abandon": "abandon", "profile": "profile"},
    ...
    "duck success": {"next": "start", "profile" : "profile"},
    "profile": {"coding": "start"},
    "sucess": {"profile": "profile", "start": "start"},
}

analisis ={
    "zen":"Your definition of Zen is borderline between 'My body is a Temple' and 'fulfilling every little \
bodily impulses of mine is prior to...'. As Bobby said: it is your prerogative. And after all, we don't want you complaining, or \
stressed, unhappy, sick, hungry...it's not good for business! However, you also need a roof over your head. \
Have you done any work today?",
    "angry":"Terrible! Intimidating. A constant menace to collegues and any sensitive electrical devices around you \
when you are coding. Anger issues? We all have them, especially driving during rush hour. Someday, you will realize that \
we are all angry inside. Some are better at managing/hiding it, that's all. Now, careful next time you spin out of \
control: you might open the cage for an angrier beast... and/or just get a bad rep!",
    "smart":"It is not enough to have the fastest bike, you need to keep it in functioning order and tune it to your \
preferences. Well, that bike is you brain and you are well aware of it. There's nothing we can tell you here \
that you don't already know. Keep on making the right decision and soon you will see us mortals miles away from your \
rearview mirror",
    "obsessed":"You are definitely very confident in your own capacities. But, you end up sooooo tired, soooo exhausted...\
and after a while, so is everyone around you. Not sure you can keep this up for long. How about tomorrow? \
...
Or is your best friend an A.I.? Also, how's your coding going? Any notable progress lately?",
}